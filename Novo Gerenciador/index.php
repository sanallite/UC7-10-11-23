    ...
    <body>
        ...
        <?php
            ...
            if ( isset($_GET['conclusao']) ) {
                ...
                "<h3>Tarefas marcadas como concluídas!</h3>" : "";

                echo $_GET['conclusao'] == 'cancelada' ?
                "<h3>Tarefas marcadas como canceladas!</h3>" : "";

                echo $_GET['conclusao'] == 'erro' ?
                "<h3>Erro na conclusão das tarefas.</h3>" : "";
            }

            if ( isset($_GET['tarefa_excluida']) ) {
                echo $_GET['tarefa_excluida'] == 'true' ?
                "<h3>Tarefas excluídas com sucesso!</h3>" : "";

                echo $_GET['tarefa_excluida'] == 'false' ?
                "<h3>Erro na exclusão das tarefas.</h3>" : "";

                echo $_GET['tarefa_excluida'] == 'todas' ?
                "<h3>Todas as tarefas foram excluídas!</h3>" : "";

                echo $_GET['tarefa_excluida'] == 'nenhuma' ?
                "<h3>Erro na exclusão das tarefas.</h3>" : "";
            }

            if ( isset($_GET['contato_excluido']) ) {
                echo $_GET['contato_excluido'] == 'true' ?
                "<h3>Contato(s) excluído(s) com sucesso!</h3>" : "";

                echo $_GET['contato_excluido'] == 'false' ?
                "<h3>Erro na exclusão do(s) contato(s).</h3>" : "";

                echo $_GET['contato_excluido'] == 'todos' ?
                "<h3>Todos os contatos foram excluídos!</h3>" : "";

                echo $_GET['contato_excluido'] == 'nenhum' ?
                "<h3>Erro na exclusão dos contatos.</h3>" : "";
            }
        ?>
        ...
        <input type="submit" name="concluirTodas" value="Marcar todas as tarefas como concluídas" formaction="alterar_conclusao.php?acao=concluirTodas">
        <input type="submit" name="cancelarTodas" value="Marcar todas as tarefas como canceladas" formaction="alterar_conclusao.php?acao=cancelarTodas">
        <input type="submit" name="excluirTodasT" value="Excluir todas as tarefas" formaction="excluir.php?acao=excluirTodasT">
        </form>
        ...
        <input type="submit" name="excluirTodosC" value="Excluir todos os contatos" formaction="excluir.php?acao=excluirTodosC">
        </form>
